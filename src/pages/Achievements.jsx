  ...
  },
  {
    ...
    description: (
      <>
        ...
        using <b>Jetson–based sensor nodes</b> to collect{' '}
        <b>real-time soil and environmental data</b>. <b>Machine learning models</b>{' '}
        trained on historical agricultural data recommended <b>crops</b>{' '}
        ...
        <b>real-time monitoring and analytics</b>, showing a{' '}
        <b>scalable agriculture solution</b> 
      </>
    ),
  },
  {
