...
const About = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="about-section py-16 sm:py-24 relative overflow-hidden bg-[#1a1a2e]"
    >
          ...
          >
            ...
            >
              <div className="flex flex-col gap-4 sm:gap-6 pointer-events-auto">
                {/* LeetCode */}
                <a href={socialLinks.leetcode} target="_blank" rel="noreferrer" className="group w-full">
                  <div className="glass-strong rounded-2xl p-4 border border-white/10 group-hover:border-yellow-500/30 transition-all flex flex-col">
                ...
                {/* LinkedIn */}
                <a href={socialLinks.linkedin} target="_blank" rel="noreferrer" className="group w-full">
                  <div className="glass-strong rounded-2xl p-4 border border-white/10 group-hover:border-blue-500/30 transition-all flex flex-col">
                    <div className="flex items-center gap-2 mb-3 justify-center">
                ...
                {/* GitHub */}
                <a href={socialLinks.github} target="_blank" rel="noreferrer" className="group w-full">
                    ...
                    >
                      {stat.link ? (
                        <a 
                          ...
                          className="block h-full cursor-pointer relative z-50 pointer-events-auto"
                        >
                          {Content}
                        </a>
                      ) : (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {certifications.map((cert, i) => (
                    <motion.a
                      ...
                      className="group flex flex-col p-2.5 rounded-xl bg-white/5 border border-white/5 hover:border-purple-500/30 hover:bg-purple-500/5 transition-all duration-300 relative z-50 pointer-events-auto"
                    >
