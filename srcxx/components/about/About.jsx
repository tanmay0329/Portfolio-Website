...
const About = () => {
  ...
  const stats = useMemo(
    () => [
      {
        icon: <img src="/achievements_stats.webp" alt="Achievements" className="w-12 h-12 shrink-0 min-w-[48px] object-contain mx-auto rounded-lg" />,
      ...
      {
        icon: <img src="https://aburobocon2025.mnb.mn/images/logo.png" alt="Robocon" className="w-12 h-12 shrink-0 min-w-[48px] object-contain mx-auto" />,
      ...
      {
        icon: <img src="/matlab.webp" alt="MATLAB" className="w-10 h-10 shrink-0 min-w-[40px] object-contain rounded-lg mx-auto" />,
      ...
      {
        icon: <img src="https://www.ihfc.co.in/wp-content/uploads/2025/08/Artboard-43-scaled.png" alt="IHFC" className="w-16 h-10 shrink-0 min-w-[64px] object-contain mx-auto brightness-125" />,
